      ...
      <main className="relative z-10">
          ...
          <div className="container mx-auto px-4">
            <div className="grid grid-col-1 xl:grid-cols-2 items-center gap-12">
              <div className="p-5">
                ...
                >
                  <Badge className="mb-4 bg-indigo-100 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-400 border-indigo-200 dark:border-indigo-700/30 px-3 py-1">
                  ...
                  <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight text-slate-900 dark:text-white">
                    Learn, Stake &{" "}
                    <span className="bg-clip-text text-transparent text-black">
                      Earn
                    </span>{" "}
                    in the World of DeFi
                  </h1>
                  <p className="text-lg md:text-xl text-slate-600 dark:text-slate-300 mb-8 max-w-2xl">
                    xfiCredit combines education with real-world DeFi staking,
              ...
              <div className="p-5">
                <motion.div
                  ...
                  className="relative"
                >
                  <div className="absolute -inset-0.5 bg-gradient-to-r from-purple-500 to-yellow-500 rounded-2xl blur opacity-30 dark:opacity-50"></div>
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl font-bold mb-4 text-slate-900 dark:text-white">
                Why Choose{" "}
                <span className="bg-clip-text text-transparent bg-gradient-to-r from-purple-500 to-yellow-500">
                  xfiCredit
                </span>
              </h2>
        ...
        >
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <TestimonialCard
                quote="xfiCredit completely changed how I approach DeFi education."
                name="Sarah"
                role="Developer"
                image=""
                type="educator"
        ...
        <section className="py-20">
          <div className="container mx-auto px-4">
            <div className="relative overflow-hidden rounded-3xl">
              <div className="absolute inset-0 bg-gradient-to-r from-purple-500 to-yellow-500 opacity-90"></div>
              ...
              >
                ...
                <p className="text-lg text-white/90 max-w-2xl mx-auto mb-10">
                  Join thousands of students and educators on xfiCredit and
...
function StepCard({
  ...
  return (
    <motion.div
      ...
      viewport={{ once: true }}
    >
      <div className="absolute -left-4 top-0 w-8 h-8 rounded-full bg-gradient-to-r from-purple-500 to-yellow-500 flex items-center justify-center text-white font-bold text-sm">
        {number}
      </div>
        ...
        >
          <div
            className={`w-full h-1 rounded-full ${
                            type === "educator" ? "bg-black" : "bg-black"
            } mb-6`}
          ></div>
