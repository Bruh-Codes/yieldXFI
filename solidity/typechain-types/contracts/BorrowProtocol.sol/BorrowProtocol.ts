...
export interface BorrowProtocolInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "fundNativePool",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface BorrowProtocol extends BaseContract {
  ...
  batchLiquidate: TypedContractMethod<
    [users: AddressLike[], loanIds: BigNumberish[]],
    [void],
    "nonpayable"
  >;

  borrowNative: TypedContractMethod<
    [
      _collateralToken: AddressLike,
      _collateralAmount: BigNumberish,
      _borrowToken: AddressLike,
  ...
  calculateHealthFactorSimulated: TypedContractMethod<
    [
      _collateralAmount: BigNumberish,
      _borrowAmount: BigNumberish,
      _collateralTokenAddress: AddressLike
    ],
    [bigint],
    "view"
  >;
  ...
  fundNativePool: TypedContractMethod<[], [void], "payable">;
  ...
  payLoan: TypedContractMethod<[_loanId: BigNumberish], [void], "payable">;
  ...
  yieldTokenAddress: TypedContractMethod<[], [string], "view">;
  ...
  getFunction(
    nameOrSignature: "fundNativePool"
  ...
  getFunction(
    nameOrSignature: "yieldTokenAddress"
  ): TypedContractMethod<[], [string], "view">;
