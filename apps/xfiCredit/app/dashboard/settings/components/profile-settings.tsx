						...
						<div className="flex-1 space-y-4">
							<div className="grid grid-cols-1 gap-4 md:grid-cols-2">
								<div className="space-y-2">
									...
									<Input
										className="bg-slate-100 dark:bg-slate-800/50 border-slate-200 dark:border-slate-700 text-slate-900 dark:text-slate-100 placeholder:text-slate-400 dark:placeholder:text-slate-500 focus:!ring-slate-500 dark:focus:!ring-purple-500 focus:!border-transparent focus:ring-offset-2 dark:ring-offset-purple-700 ring-offset-slate-700"
										id="name"
										value={userData.name}
										onChange={(e) =>
